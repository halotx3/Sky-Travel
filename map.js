...
const runmaps = function (){
  ...
  let bingurl = `https://cors-anywhere.herokuapp.com/http://dev.virtualearth.net/REST/v1/Imagery/Map/Road/${isLat},${isLong}/15?mapSize=550,550&pp=${isLat},${isLong}&key=${bingapiKey}`
